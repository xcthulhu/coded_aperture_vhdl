set ate=ctype_h_test_vhdle_ate.txt
...
vhdlp -work work -strict -maxerrors 10 -nostderr ../../../test/ctype_h_test.vhd  >>%ate%
rem
rem  file i/o:     -stdin <file> -stdout <file>
rem  silent mode:  -s
rem  command file: -do <file>
rem  
vhdle -work work -strict -nostderr ctype_h_test_cfg >>%ate%
more <%ate%
